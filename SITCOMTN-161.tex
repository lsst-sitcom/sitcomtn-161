...
$\langle R_2^{-1} -1 \rangle = 1$, we get $\langle \delta m \rangle = 0.002$; this on par with the typical requirements for $3 \times 2$-point analyses \citep{2018arXiv180901669T}, which are more demanding than the use case of galaxy cluster lensing we are considering here.
